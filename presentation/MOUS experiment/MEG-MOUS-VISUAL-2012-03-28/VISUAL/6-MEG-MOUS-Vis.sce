...
# [wav file] [audio file length][target location] [Has question = 1] [Stimuli]
	...
	int len = fileLength("6MEG-A5A6-Sent-28-Mar-2012.txt"); # OBS! The files for sentences and sequences MUST be of equal length
 	array <string> Sent[len] = readfileLines("6MEG-A5A6-Sent-28-Mar-2012.txt"); 	
	array <string> Seq[len] = readfileLines("6MEG-B2B3-Seq-28-Mar-2012.txt"); 		
