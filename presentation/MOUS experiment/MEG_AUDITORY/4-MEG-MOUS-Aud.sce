...
# [wav file] [senstence onset][target location] [audio file length][Has question > 0 (answer = 1 | 2)] 
	...
	int len = fileLength("4MEG-A4A5-Sent-05-Dec-2012.txt"); # OBS! The files for sentences and sequences MUST be of equal length
 	array <string> Sent[len] = readfileLines("4MEG-A4A5-Sent-05-Dec-2012.txt"); 	
	array <string> Seq[len] = readfileLines("4MEG-B1B2-Seq-05-Dec-2012.txt"); 	
