...
# [wav file] [senstence onset][target location] [audio file length][Has question > 0 (answer = 1 | 2)] 
	...
	int len = fileLength("6MEG-A5A6-Sent-05-Dec-2012.txt"); # OBS! The files for sentences and sequences MUST be of equal length
 	array <string> Sent[len] = readfileLines("6MEG-A5A6-Sent-05-Dec-2012.txt"); 	
	array <string> Seq[len] = readfileLines("6MEG-B2B3-Seq-05-Dec-2012.txt"); 	
