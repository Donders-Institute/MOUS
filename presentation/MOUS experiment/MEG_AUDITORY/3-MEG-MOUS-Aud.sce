...
# [wav file] [senstence onset][target location] [audio file length][Has question > 0 (answer = 1 | 2)] 
	...
	int len = fileLength("3MEG-A3A2-Sent-05-Dec-2012.txt"); # OBS! The files for sentences and sequences MUST be of equal length
 	array <string> Sent[len] = readfileLines("3MEG-A3A2-Sent-05-Dec-2012.txt"); 	
	array <string> Seq[len] = readfileLines("3MEG-B5B6-Seq-05-Dec-2012.txt"); 	
