...
# [wav file] [audio file length][target location] [Has question = 1] [Stimuli]
	...
	int len = fileLength("2MEG-A3A1-Sent-28-Mar-2012.txt"); # OBS! The files for sentences and sequences MUST be of equal length
 	array <string> Sent[len] = readfileLines("2MEG-A3A1-Sent-28-Mar-2012.txt"); 	
	array <string> Seq[len] = readfileLines("2MEG-B6B4-Seq-28-Mar-2012.txt"); 		
