...
scenario = "5-fMRI-MOUS-Aud";                           					# Name of scenario (for logfile use)
...
# [wav file] [sentence onset] [target onset] [audio file length][Has question > 0 (answer = 1 | 2)] 
	...
	int len = fileLength("5fMRIvis-A5-Sent-05-Dec-2012.txt"); # OBS! The files for sentences and sequences MUST be of equal length
 	array <string> Sent[len] = readfileLines("5fMRIvis-A5-Sent-05-Dec-2012.txt"); 	
	array <string> Seq[len] = readfileLines("5fMRIvis-B2-Seq-05-Dec-2012.txt"); 	
