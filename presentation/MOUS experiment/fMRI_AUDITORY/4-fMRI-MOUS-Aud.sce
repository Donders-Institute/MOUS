...
scenario = "4-fMRI-MOUS-Aud";                           					# Name of scenario (for logfile use)
...
# [wav file] [sentence onset] [target onset] [audio file length][Has question > 0 (answer = 1 | 2)] 
	...
	int len = fileLength("4fMRIvis-A6-Sent-05-Dec-2012.txt"); # OBS! The files for sentences and sequences MUST be of equal length
 	array <string> Sent[len] = readfileLines("4fMRIvis-A6-Sent-05-Dec-2012.txt"); 	
	array <string> Seq[len] = readfileLines("4fMRIvis-B3-Seq-05-Dec-2012.txt"); 	
