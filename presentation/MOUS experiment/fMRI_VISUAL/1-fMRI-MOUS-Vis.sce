 ...
 scenario = "1-fMRI-MOUS-Vis";                           			# Name of scenario (for logfile use)
...
# [wav file] [audio file length][target location] [Has question = 1] [Stimuli]
	...
	int len = fileLength("1fMRIvis-A3-Sent-28-Mar-2012.txt"); # OBS! The files for sentences and sequences MUST be of equal length
 	array <string> Sent[len] = readfileLines("1fMRIvis-A3-Sent-28-Mar-2012.txt"); 	
	array <string> Seq[len] = readfileLines("1fMRIvis-B6-Seq-28-Mar-2012.txt"); 		
