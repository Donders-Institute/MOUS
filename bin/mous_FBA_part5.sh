...
mrregister $output_folder/wmfod_norm.mif -mask1 $output_folder/data_mask.nii.gz $group_folder_dwi/wmfod_template.mif -nl_warp $output_folder/subject2template_warp.mif $output_folder/template2subject_warp.mif -force

# Warp the mask into template space:
mrtransform $output_folder/data_mask.nii.gz -warp $output_folder/subject2template_warp.mif -interp nearest -datatype bit $output_folder/dwi_mask_in_template_space.mif -force
