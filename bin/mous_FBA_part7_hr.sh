...
mrtransform $output_folder/wmfod.mif -warp $output_folder/subject2template_warp.mif -noreorientation $output_folder/fod_in_template_space_NOT_REORIENTED.mif -force
