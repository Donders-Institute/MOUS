...
#population_template $group_folder_dwi/fod_input $group_folder_dwi/wmfod_template.mif -mask_dir $group_folder_dwi/mask_input -voxel_size 2.2 -tempdir $group_folder_dwi/tempdir -nocleanup -force > $group_folder_dwi/population_template.log 2>&1
