function [data] = mous_preprocessing(filename, trl, resamplefs, analysisType, inputcfg)

%% Preprocess data
% Created by AH, NL. 31-5-2012, and adjusted by JM

if nargin<5,
  % if no custom cfg is in the input, specify the options for preprocessing
  % here
  cfg         = [];
