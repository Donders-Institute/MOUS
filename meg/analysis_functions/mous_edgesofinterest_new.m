function [C, label, P, list, lay] = mous_edgesofinterest_new
...
C = max(C, makeconnections(label2, 'L_19', 'L_temp_sup_post', [1 2]));
C = max(C, makeconnections(label2, 'L_19', 'L_temp_sup_mid', [1 2]));
C = max(C, makeconnections(label2, 'L_19', 'L_temp_sup_inf', [1 2]));
C = max(C, makeconnections(label2, 'L_19', 'L_39', [1 2]));
C = max(C, makeconnections(label2, 'R_19', 'R_temp_sup_post', [1 2]));
C = max(C, makeconnections(label2, 'R_19', 'R_temp_sup_mid', [1 2]));
C = max(C, makeconnections(label2, 'R_19', 'R_temp_sup_inf', [1 2]));
C = max(C, makeconnections(label2, 'R_19', 'R_39', [1 2]));
