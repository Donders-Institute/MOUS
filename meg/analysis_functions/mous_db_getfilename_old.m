function [filename, st, info] = mous_db_getfilename_old(subject, type, infoflag, rootdir)
...
% ensure the old subject naming convention
subject = strrep(subject, 'sub-1', 'V1');
subject = strrep(subject, 'sub-2', 'A2');
