function [segment] = mous_anatomy_volumeedit(mri)

% MOUS_ANATOMY_VOLUMEEDIT allows for manual editing of segmented volumes
% similar to tkmedit.

fprintf(['You can remove unwanted voxels by using\n',...
           'the right mous button, or by pressing the ''d'' key after selection of\n',...
           'the voxel. You can also keep the right mouse button pressed, and drag\n',...
           'the mouse over the region of voxels you want to have removed. The\n'...
           'radius of the eraser box can be specified with the ''r'' key.\n',...
           'Press ''q'' to exit.\n']);
         
segment         = mri;
segment.anatomy = volumeedit(segment.anatomy);
