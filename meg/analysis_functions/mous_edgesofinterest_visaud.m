function [C, label, P, list, lay] = mous_edgesofinterest_visaud
...
% switch off the subparcels of 18/19 that are 'irrelevant', i.e. on the
% medial part of the cortex:
sel = find(strncmp(label2,'L_18',4));
sel = sel(5:7);
for k = 1:numel(sel)
  label2{sel(k)} = strrep(label2{sel(k)},'18_','18x_');
end
sel = find(strncmp(label2,'R_18',4));
sel = sel(5:7);
for k = 1:numel(sel)
  label2{sel(k)} = strrep(label2{sel(k)},'18_','18x_');
end
sel = find(strncmp(label2,'L_19',4));
sel = sel([1 5 6 10 12]);
for k = 1:numel(sel)
  label2{sel(k)} = strrep(label2{sel(k)},'19_','19x_');
end
sel = find(strncmp(label2,'R_19',4));
sel = sel([1 5 6 10 12]);
for k = 1:numel(sel)
  label2{sel(k)} = strrep(label2{sel(k)},'19_','19x_');
end
...
C = max(C,  makeconnections(label2, 'L_45', 'L_18_', [2 1]));
C = max(C,  makeconnections(label2, 'L_45', 'L_19_', [2 1]));
...
C = max(C,  makeconnections(label2, 'L_47', 'L_18_', [2 1]));
C = max(C,  makeconnections(label2, 'L_47', 'L_19_', [2 1]));
...
C = max(C,  makeconnections(label2, 'R_45', 'R_18_', [2 1]));
C = max(C,  makeconnections(label2, 'R_45', 'R_19_', [2 1]));
...
C = max(C,  makeconnections(label2, 'R_47', 'R_18_', [2 1]));
C = max(C,  makeconnections(label2, 'R_47', 'R_19_', [2 1]));
...
C = max(C,  makeconnections(label2, 'L_temp_mid_mid', 'L_temp_inf_mid', [1 1])); %new
C = max(C,  makeconnections(label2, 'L_temp_mid_ant', 'L_temp_inf_ant', [1 1])); %new
...
C = max(C,  makeconnections(label2, 'R_temp_mid_mid', 'R_temp_inf_mid', [1 1])); %new
C = max(C,  makeconnections(label2, 'R_temp_mid_ant', 'R_temp_inf_ant', [1 1])); %new

% NEW: also connect 19 with posterior temporal, and 19 with 39 -> otherwise visual info can
% hardly propagate into the system
C = max(C, makeconnections(label2, 'L_19_', 'L_temp_sup_post', [1 2]));
C = max(C, makeconnections(label2, 'L_19_', 'L_temp_sup_mid', [1 2]));
C = max(C, makeconnections(label2, 'L_19_', 'L_temp_sup_inf', [1 2]));
C = max(C, makeconnections(label2, 'L_19_', 'L_39', [1 2]));
C = max(C, makeconnections(label2, 'R_19_', 'R_temp_sup_post', [1 2]));
C = max(C, makeconnections(label2, 'R_19_', 'R_temp_sup_mid', [1 2]));
C = max(C, makeconnections(label2, 'R_19_', 'R_temp_sup_inf', [1 2]));
C = max(C, makeconnections(label2, 'R_19_', 'R_39', [1 2]));
...
C = max(C,  makeconnections(label2, 'L_17', 'L_18_', [1 2]));
C = max(C,  makeconnections(label2, 'L_18_', 'L_19_', [1 2]));
%C = max(C,  makeconnections(label, 'L_17', 'L_19', [1 2]));

C = max(C,  makeconnections(label2, 'R_17', 'R_18_', [1 2]));
C = max(C,  makeconnections(label2, 'R_18_', 'R_19_', [1 2]));
%C = max(C,  makeconnections(label, 'R_17', 'R_19_', [1 2]));
...
C = max(C,  makeconnections(label2, 'R_18_', 'L_18_', [1 1]));
C = max(C,  makeconnections(label2, 'R_19_', 'L_19_', [1 1]));
...
% NEW: also add the primary auditory regions, and connect them with area
% 40, and the appropriate parts of 22
C = max(C, makeconnections(label, 'L_41', 'L_40', [1 2]));
C = max(C, makeconnections(label, 'L_42', 'L_40', [1 2]));
C = max(C, makeconnections(label, 'L_41', 'L_42', [1 2]));
C = max(C, makeconnections(label, 'R_41', 'R_40', [1 2]));
C = max(C, makeconnections(label, 'R_42', 'R_40', [1 2]));
C = max(C, makeconnections(label, 'R_41', 'R_42', [1 2]));

C = max(C, makeconnections(label2, 'L_41', 'L_temp_sup_post', [1 2]));
C = max(C, makeconnections(label2, 'L_42', 'L_temp_sup_post', [1 2]));
C = max(C, makeconnections(label2, 'L_41', 'L_temp_sup_mid', [1 2]));
C = max(C, makeconnections(label2, 'L_42', 'L_temp_sup_mid', [1 2]));
C = max(C, makeconnections(label2, 'R_41', 'R_temp_sup_post', [1 2]));
C = max(C, makeconnections(label2, 'R_42', 'R_temp_sup_post', [1 2]));
C = max(C, makeconnections(label2, 'R_41', 'R_temp_sup_mid', [1 2]));
C = max(C, makeconnections(label2, 'R_42', 'R_temp_sup_mid', [1 2]));

C = max(C, makeconnections(label, 'L_41', 'R_41', [1 1]));
C = max(C, makeconnections(label, 'L_42', 'R_42', [1 1]));
...
cfg.rho = [10:7.5:47.5 60 68 80:7.5:140 151:8:167 193:8:209 220:7.5:280 292 300 312.5:7.5:350];
cfg.layout = 'circular';
