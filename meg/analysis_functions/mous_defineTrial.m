function [trl, sel] = mous_defineTrial(filename, prestim, poststim, trialfun, varargin)

adjustdelay = ft_getopt(varargin, 'adjustdelay', 'yes');
...
if strcmp(f(1),'V') && istrue(adjustdelay)
  warning('adjustment of the timing for the presentation delay is only implemented for audio presentation');
end
...
cfg.trialdef.adjustdelay = adjustdelay;
