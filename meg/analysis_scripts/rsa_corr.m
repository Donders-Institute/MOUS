function [mv_corr,mv2_corr,ma_corr,ma2_corr,ms_corr,ms2_corr,ms3_corr] = rsa_corr(voxelstart,voxelend,latewindow,windowsize)
...
for k = voxelstart:voxelend
    ...
    ms2_corr(count) = corr(squareform(M,'tovector')',ms2','type','spearman','rows','complete');
    ms3_corr(count) = corr(squareform(M,'tovector')',ms3','type','spearman','rows','complete');
    count = count+1;
