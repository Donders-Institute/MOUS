...
% note for MOUS: cfg.correctm = a local correction (each freq-time point)
% However, also need to do a bonferroni afterwards accounting that
...
save('Group_16ptp_SentvsSeqPerm_Lay2_Hann4Under30Hz_19July2012','statroi1','statroi2','nsubj','freq1','freq2','roi'); %freq1_b,freq2_b
