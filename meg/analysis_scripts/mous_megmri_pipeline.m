...
if ~exist('fname',    'var'),     fname = 'beta_0001';                    end

% HARD CODED, remove!
figpath  = '/project/3011020.09/MEG/results/20140413';  
...
if dointerp3d
  ...
  mous_db_makesubjdir(subjectname, rootdir, {'megmri'});
  mous_db_putdata(subjectname, ['meg_megmri_' fname '_3d'], 'mri', rootdir);
