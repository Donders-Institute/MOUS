...
%subjectname = 'V1086'; % if running from the middle you need this
...
if ~exist('dosourcemodel3d',  'var'),
    dosourcemodel3d  = true;
end
if ~exist('doqualitycheck',   'var'),
    doqualitycheck   = true;
end

s  = {'V1070','V1074','V1080','V1081','V1083','V1084','V1085','V1086',...
    'V1087','V1088','V1089','V1093','V1099'};
for j = 1:length(s)
